...
def approve_user(call):
    ...
    # Sirf OWNER approve kar sakta hai
...
def reject_user(call):
    ...
    # Sirf OWNER reject kar sakta hai
    if call.from_user.id != OWNER_ID:
...
def handle_message(message):
    ...
    # =====================================================
    # VERY IMPORTANT:
    # API CALL SE PEHLE ACCESS CHECK
    # =====================================================
    ...
    # =====================================================
    # OWNER / APPROVED USER YAHAN SE SEARCH KAR SAKTA HAI
    # =====================================================
    ...
    try:
        ...
        reply_text += (
            ...
            "💬 **Support:** "
            "[Telegram Support](https://t.me/FREEHACKS95)\n"

            "📢 **Channels:** "
            "[Telegram](https://t.me/+zLVbS12-FxMyMmM0)"
